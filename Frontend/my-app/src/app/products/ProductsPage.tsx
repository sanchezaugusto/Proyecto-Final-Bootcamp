...
const ProductsPage = () => {
  ...
  const { setCategories, selectedCategory, priceRange, applyFilter, filteredProducts } = useFilter();
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        setCategories([...new Set(formattedData.map((p: any) => p.category))]);
      } catch (error) {
  ...
  useEffect(() => {
    applyFilter();
  }, [selectedCategory, priceRange, applyFilter]);
