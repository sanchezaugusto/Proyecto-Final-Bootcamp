...
const InputSearch = ({ setProducts }: Props) => {
  const { selectedCategory, priceRange, isSubCategory, name, setName, applyFilter } = useFilter();

  const handleOnClick = async () => {
    console.log(selectedCategory, priceRange, isSubCategory);
    await applyFilter(); // Llama a la función de filtrado del contexto
    setProducts(filteredProducts); // Actualiza los productos en el estado del componente padre
  };
